...
Install()
{
    ...
    # 获取onmp脚本
    curl -kfsSL https://ghproxy.com/https://raw.githubusercontent.com/xzhih/ONMP/master/onmp.sh > /opt/onmp/onmp.sh
    # curl -kfsSL http://192.168.4.126:4000/onmp.sh > /opt/onmp/onmp.sh
    chmod +x /opt/onmp/onmp.sh

    # 获取php探针文件
    curl -kfsSL https://ghproxy.com/https://raw.githubusercontent.com/WuSiYu/PHP-Probe/master/tz.php > /opt/onmp/tz.php
